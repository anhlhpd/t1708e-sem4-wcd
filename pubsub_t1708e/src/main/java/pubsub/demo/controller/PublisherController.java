...
public class PublisherController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ProjectTopicName topicName = ProjectTopicName.of(PubsubConstant.GOOGLE_CLOUD_PROJECT_ID, PubsubConstant.TOPIC_ID);
        ...
        resp.getWriter().print("Send message successs!");
    }
}
