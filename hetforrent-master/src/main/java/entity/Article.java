...
public class Article {
    ...
    @Index
    @Load
    List<Ref<Category>> listCategory;
    ...
    public List<Ref<Category>> getListCategory() {
        return listCategory;
    }

    public void setListCategory(List<Ref<Category>> listCategory) {
    ...
    public static final class Builder {
        ...
        public Builder withListCategory(List<Ref<Category>> listCategory) {
            this.listCategory = listCategory;
            return this;
        }
        ...
        public Article build() {
            ...
            article.setListCategory(listCategory);
            return article;
        }
    }
}
